class Wrex < Formula
  ...
  url "https://gitlab.com/hitdevs/wrex/-/archive/v0.3.1/wrex-v0.3.1.tar.gz"
  sha256 "585ef07fd3d399ef29ec343f36275c8d77556ea0eb0e24bb76f3c84b6351f46a"
  license "MIT"
  ...
  test do
    assert_match "wrex 0.3.1", shell_output("#{bin}/wrex --version")
  end
end
